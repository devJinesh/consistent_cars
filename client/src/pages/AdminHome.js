    ...
    <DefaultLayout>
      {user.admin ? (
        <Row justify="center" gutter={16} className="mt-2">
          <Col lg={20} sm={24}>
            <div className="d-flex justify-content-between align-items-center" style={{ alignContent: "center", marginTop: "50px" }}>
          ...
          {totalCars.map((car) => {
            return (
              <Col lg={5} sm={24} xs={24}>
                <div className="car p-2 bs1 mb-2" style={{ marginTop: "35px", alignContent:"center", justifyContent: "center" }}>
